...
$result = mysqli_query($db,"SELECT * FROM woman where ProductType='Trousers and shorts-Pants And Palazzos'");

echo "<h1 class = 'f'> Trousers and shorts-Pants & Palazzos</h1><hr>";
